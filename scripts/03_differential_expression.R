...
# Select the 30 restrictive DEGs with the strongest absolute log2FC.
...
heatmap_genes <- heatmap_genes[
  !duplicated(heatmap_genes$gene_symbol),
  ,
  drop = FALSE
]
...
# Extract voom expression values.
...
# Standardize expression per gene (row Z-score).
...
if (requireNamespace("pheatmap", quietly = TRUE)) {
  ...
  pheatmap::pheatmap(
    ...
    filename =
      "figures/heatmap_top30_DEGs.png",
  ...
  pheatmap::pheatmap(
    ...
    filename =
      "figures/heatmap_top30_DEGs.pdf",
